...
* The net book is cross-verified against the PINNED FMA3 artifact
  ``engine/books.py::build_v34_frac_1h()`` (the fma3_v1_pin.json v34 positions
...
* Config drift hard-fails twice: the FMA2 brain hash must equal
  ``48c09199fbf83d82`` (the v3.4 book lock) AND the FMA3 federation hash
...
def main() -> int:
    ...
    # ---- FMA3 federation lock (the stamped hash) ----
