//+------------------------------------------------------------------+
//| CheckIntraday.mq5 — compile/smoke gate for Sat/Intraday.mqh  |
//|                                                                  |
//| Instantiates CSatIntradayStepper, feeds ~96 synthetic hourly     |
...
void OnStart()
  {
   ...
   CSatIntradayStepper stepper;
   stepper.Init(syms, 16, 21, 2.0, 60.0, 0.15, 1.111, 30.0, 24.0, 0.30, 1);

   CSatIntradayStepper replay;                    // warm-start clone
   ...
   long   snap_day = 0;
   SSatIntradaySymState snap_syms[];
