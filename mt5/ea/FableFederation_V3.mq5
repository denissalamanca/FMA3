//+------------------------------------------------------------------+
//| FableFederation_V3.mq5 - faithful executor of the v3 stable model. |
//|                                                                    |
...
//====================================================================
#include <FMA3v3/FedConvert.mqh>   // FED_MidOf, FED_Eurq (uses InpEUR* above)
#include <FMA3v3/FedReplay.mqh>    // universe table + fmt=3 loader (uses InpFedFracFile/Map/MagicBase)
#include <FMA3v3/FedExec.mqh>      // `trade`, primitives, FED_Reconcile (uses InpScale/MarginCap/RebalBand/Log)
#include <FMA3v3/Guardian.mqh>     // FED_GuardianPass (uses InpDailyStopX/InpInitial)
